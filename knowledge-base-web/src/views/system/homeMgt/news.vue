    ...
    <div class="news">
        ...
        <div class="content">
            <div class="table-top mb20">
               ...
               <el-button class="btn_bg_blue" @click="editNews('add')">新增新闻</el-button>
            </div>
            <div class="table-box">
                <el-table
                        :data="tableData"
                    ...
                    <el-table-column
                            ...
                            label="操作">
                        <template slot-scope="scope">
                            <span class="cursor_p" @click="editNews('edit', scope.row.id)">
    ...
    methods: {
        ...
        deleteItem (id, name) {
          this.$confirm('确定删除' + name + '”?', '删除', {
            ...
            this.$api.removeJournalism({ id: id }).then(res => {
